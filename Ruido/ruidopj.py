...
cam = ""         #Caminho onde fica a imagem a ser processada
...
def ruido():
    ...
    g2 = float(input("Digite o valor para operação com ruido gaussiano: "))
    ...
    #PLOTAGEM DAS IMAGEM APOS A INSERÇÃO DE RUIDO GAUSSIANO
    plt.figure(figsize=(15,10))
    plt.subplot(121), plt.imshow(image, cmap='gray'),plt.title('Imagem Original')
    plt.xticks([]), plt.yticks([])
    plt.subplot(122), plt.imshow(ruido2mul, cmap='gray'),plt.title('Ruido Gaussiano com valor especificado')
    plt.xticks([]), plt.yticks([])
    ...
    #PLOTAGEM DAS IMAGEMS APOS INSERÇÃO DE RUIDO S&P
    plt.figure(figsize=(15,10))
...
print("\nBem vindo ao programa de inserção de ruido,filtragem e detecção de borda de uma imagem!!")
menu()